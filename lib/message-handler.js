...
module.exports = function getMessageHandler(opts) {
    var options = opts || {};
    ...
    function messageHandler(msg) {
        ...
        if (options.users !== '*' && options.users.indexOf(msg.image.user) === -1) {
            return log('trace', 'Message did not have recognized user (`' + msg.image.user + '`)');
        }
